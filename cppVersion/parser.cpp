/* Generated by re2c 3.0 on Tue Jan 31 15:52:27 2023 */
...
yy16:
#line 176 "parser.y"
	{ return s(nscr_parser::make_ICST, std::stoi(std::string(anchor, ctx.cursor))); }
...
yy22:
#line 172 "parser.y"
	{ return s(nscr_parser::make_ID, std::string(anchor, ctx.cursor)); }
...
yy40:
#line 177 "parser.y"
	{ return s(nscr_parser::make_FCST, std::stof(std::string(anchor, ctx.cursor))); }
...
yy68:
	++ctx.cursor;
#line 164 "parser.y"
	{ return s(nscr_parser::make_HEND);   }
#line 4315 "parser.cpp"
yy69:
	++ctx.cursor;
#line 165 "parser.y"
	{ return s(nscr_parser::make_HSUB);   }
...
yy72:
#line 169 "parser.y"
	{ return s(nscr_parser::make_ICST, 0); }
...
yy75:
#line 167 "parser.y"
	{ return s(nscr_parser::make_ICST, 1); }
...
yy82:
#line 160 "parser.y"
	{ return s(nscr_parser::make_WHILE);  }
#line 4638 "parser.cpp"
yy83:
	++ctx.cursor;
#line 163 "parser.y"
	{ return s(nscr_parser::make_HBEGIN); }
...
yy85:
#line 159 "parser.y"
	{ return s(nscr_parser::make_RETURN); }
