...
rules, stateTable = rg.readfile("grammarDefOfGrammarDef.txt")
logLevel = 0
...
def parse(tokens: [list]):
    ...
    while True:
        ...
        if action[0] == "R":
            ...
            # debug
            #print(reduceRule.out, "  : ", end="")
            #print( reduceRule.ast(toReduce))
...
if __name__ == "__main__":
    txt = ""
    with open("grammarDefOfGrammarDef.txt") as f:
        txt = f.read()
    pprint(parse([[t.parseStr(),t] for t in grammarLexer.lexAll(txt)]))
